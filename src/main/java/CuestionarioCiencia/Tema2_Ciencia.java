 ...
 * @author USUARIO
 */
public class Tema2_Ciencia extends javax.swing.JFrame {
     ...
     */
    public Tema2_Ciencia() {
        initComponents();
        this.setLocationRelativeTo(this);
        
        this.pintarImagen(this.lblImagen1, "src/Imagenes/Tema2 - Ciencia.png");
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("TEMA 2: Las Etapas de Reproducciòn");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tema2_Ciencia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tema2_Ciencia().setVisible(true);
            }
        });
    }
