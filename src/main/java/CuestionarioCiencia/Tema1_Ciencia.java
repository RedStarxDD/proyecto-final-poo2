 ...
 * @author USUARIO
 */
public class Tema1_Ciencia extends javax.swing.JFrame {
     ...
     */
    public Tema1_Ciencia() {
        initComponents();
        this.setLocationRelativeTo(this);
        
        this.pintarImagen(this.lblImagen1, "src/Imagenes/Tema1 - Historia.png");
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("TEMA 1: Los Seres Vivos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tema1_Ciencia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tema1_Ciencia().setVisible(true);
            }
        });
    }
