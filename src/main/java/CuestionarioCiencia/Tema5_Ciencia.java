 ...
 * @author USUARIO
 */
public class Tema5_Ciencia extends javax.swing.JFrame {
     ...
     */
    public Tema5_Ciencia() {
        initComponents();
        this.setLocationRelativeTo(this);
        
        this.pintarImagen(this.lblImagen1, "src/Imagenes/Tema5 - Ciencia.png");
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("TEMA 5: El átomo");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tema5_Ciencia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tema5_Ciencia().setVisible(true);
            }
        });
    }
