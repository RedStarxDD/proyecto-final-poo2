 ...
 * @author USUARIO
 */
public class Tema4_Ciencia extends javax.swing.JFrame {
     ...
     */
    public Tema4_Ciencia() {
        initComponents();
        this.setLocationRelativeTo(this);
        
        this.pintarImagen(this.lblImagen1, "src/Imagenes/Tema4 - Ciencia.png");
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("TEMA 4: Las moléculas  ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tema4_Ciencia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tema4_Ciencia().setVisible(true);
            }
        });
    }
