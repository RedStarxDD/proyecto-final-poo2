 ...
 * @author USUARIO
 */
public class Tema1_Historia extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("TEMA 1: La Revolución Francesa");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tema1_Historia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tema1_Historia().setVisible(true);
            }
        });
    }
