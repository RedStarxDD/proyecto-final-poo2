 ...
 * @author USUARIO
 */
public class Tema5_Historia extends javax.swing.JFrame {
     ...
     */
    public Tema5_Historia() {
        initComponents();
        this.setLocationRelativeTo(this);
        
        this.pintarImagen(this.lblImagen1, "src/Imagenes/Tema5 - Historia.png");
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("TEMA 5: Invasión Napoléonica a España");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tema5_Historia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tema5_Historia().setVisible(true);
            }
        });
    }
