 ...
 * @author USUARIO
 */
public class Bibliotecaderecursos_Historia extends javax.swing.JFrame {

    /**
     * Creates new form Bibliotecaderecursos
     */
    public Bibliotecaderecursos_Historia() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Historia -Sexto de primaria");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Bibliotecaderecursos_Historia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Bibliotecaderecursos_Historia().setVisible(true);
            }
        });
    }
