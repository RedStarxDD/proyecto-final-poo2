 ...
 * @author USUARIO
 */
public class Tema3_Historia extends javax.swing.JFrame {
     ...
     */
    public Tema3_Historia() {
        initComponents();
        this.setLocationRelativeTo(this);
        
        this.pintarImagen(this.lblImagen1, "src/Imagenes/Tema3 - Historia.png");
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("TEMA 3: Gobierno de las fuerzas Armadas");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tema3_Historia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tema3_Historia().setVisible(true);
            }
        });
    }
