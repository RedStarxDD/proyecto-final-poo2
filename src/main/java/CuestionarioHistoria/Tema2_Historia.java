 ...
 * @author USUARIO
 */
public class Tema2_Historia extends javax.swing.JFrame {
     ...
     */
    public Tema2_Historia() {
        initComponents();
        this.setLocationRelativeTo(this);
        
        this.pintarImagen(this.lblImagen1, "src/Imagenes/Tema2 - Historia.png");
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("TEMA 2: Buscando la Libertad del Perú");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tema2_Historia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tema2_Historia().setVisible(true);
            }
        });
    }
