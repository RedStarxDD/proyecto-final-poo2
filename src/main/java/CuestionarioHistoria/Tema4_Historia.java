 ...
 * @author USUARIO
 */
public class Tema4_Historia extends javax.swing.JFrame {
     ...
     */
    public Tema4_Historia() {
        initComponents();
        this.setLocationRelativeTo(this);
        
        this.pintarImagen(this.lblImagen1, "src/Imagenes/Tema4 - Historia.png");
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("TEMA 4: Que estudia la historia");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tema4_Historia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tema4_Historia().setVisible(true);
            }
        });
    }
